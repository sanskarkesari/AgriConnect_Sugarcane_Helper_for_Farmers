  ...
  if (!currentGuidelines) {
    return (
      <div className="bg-green-50 rounded-lg shadow-md p-6 border border-green-100">
        {language === 'en' ? 'No guidelines available for current conditions.' : 'वर्तमान स्थिति के लिए कोई दिशानिर्देश उपलब्ध नहीं हैं।'}
      </div>
    );
  }
